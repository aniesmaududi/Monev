			...
			<div id="nav-box">
				...
				<div class="box-content">
					...
					<table>
						<tr>
							<td class="button"><a href="<?php echo base_url();?>kementrian/kegiatan/<?php echo $program_item['kddept'];?>-<?php echo $program_item['kdunit'];?>-<?php echo $program_item['kdsatker'];?>-<?php echo $program_item['kdprogram'];?>" class="custom">Lihat Kegiatan</a></td>
