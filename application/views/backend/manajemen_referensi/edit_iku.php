				...
				<form action="<?php echo site_url();?>backend/ref/ubahiku" class="backend-form" method="post">
                   ...
                   <div class="clearfix">
                    ...
                    <select name="kdprogram">
                     ...
                     <option value="<?php echo $program->kdprogram;?>" <?php echo ($unit->kdunit == $detail->kdunit && $unit->kddept == $detail->kddept && $program->kdprogram == $detail->kdprogram)? 'selected=selected':'';?>><?php echo $program->nmprogram;?></option>
                        <?php endforeach;?>
                    </select>
					</div>
					<div class="clearfix">
