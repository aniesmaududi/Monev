			...
			<div id="search-box" style="min-height:400px;">
				<?php //if($user):?>
					<form action="backend/user_dja/simpan" class="backend-form" method="post">
						<h4><span>Data User DJA</span></h4>
						<?php
						...
						<div class="">
							<label for="kdjabatan">Jabatan</label>
							<?php
								$attr = 'id="kdjabatan"';
								echo form_dropdown('kdjabatan',$jab_value,set_value('kdjabatan'),$attr);
							?>
						</div>
						<div class="clearfix">
