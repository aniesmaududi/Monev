			...
			<div id="nav-box">
				...
				<div class="box-content">
					...
					<h3>Proyek Pembangunan Jembatan Kalimantan-Jawa</h3>
					...
					<table>
						<tr>
							...
							<td class="mark"><img src="<?php echo ASSETS_DIR_IMG.'done.png'?>" class="round-mark"/></td>
						</tr>
					</table>
				...
				<div class="box-content">
					...
					<table>
						<tr>
							<td class="button"><a href="#" class="custom">Isi Realisasi</a></td>
							<td class="mark"><img src="<?php echo ASSETS_DIR_IMG.'notdone.png'?>" class="round-mark"/></td>
						</tr>
					</table>
					</div><!-- end of box-content-right -->
				...
				<div class="box-content yellow">
					...
					<table>
						<tr>
							<td class="button"><a href="#" class="custom">Isi Realisasi</a></td>
							<td class="mark"><img src="<?php echo ASSETS_DIR_IMG.'new.png'?>"/></td>
						</tr>
					</table>
					</div><!-- end of box-content-right -->
