			...
			<div id="search-box">
				Program
				<form name="form-outcome" action="<?php echo base_url();?>kementrian/efisien" method="POST">					
			...
			<?php if($kdprogram != 0 && $kdgiat != 0){ ?>
				<?php echo form_open('kementrian/do_efisien_approval');?>				
				<p id="total"><img src="<?php echo ASSETS_DIR_IMG.'notdone.png';?>" class="notify"/>Daftar efisiensi yang harus diisikan nilai realisasinya.</p>				
