			...
			<div id="search-box">
				Program
				<form name="form-outcome" action="<?php echo base_url();?>kementrian/ikk" method="POST">					
			...
			echo form_open('kementrian/do_ikk_approval');
			?>
				...
				<div class="box-content">					
					...
					<div class="column4" style="padding:0;margin:0;width:120px;">
						<?php
						if($item['accunit'] == 1 && $item['accdept'] == 1)
						{
							...
							elseif($item['accunit_date'] != "0000-00-00 00:00:00" && $item['accunit'] == 0)
							{ echo '<img src="'.ASSETS_DIR_IMG.'notdone.png"><br>
