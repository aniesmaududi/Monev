			...
			<div id="search-box">
				Eselon I yang telah mengesahkan output
			</div>
			<div id="nav-box">
				<div id="box-title">
				...
				<div class="box-content">
					...
					<table>
						<tr>
							<td class="button">
							<form name="unit-outcome" method="POST" action="<?php echo base_url();?>kementrian/efisien">
								...
								<input type="submit" value="Lihat Efisiensi"/>
							</td>
