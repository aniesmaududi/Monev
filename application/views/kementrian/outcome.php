			...
			<div id="search-box">
				Program
				<form name="form-outcome" action="<?php echo base_url();?>kementrian/outcome" method="POST">
			...
			<div id="nav-box">
				<?php echo form_open('kementrian/do_outcome_approval');?>				
				<?php if($kdprogram != 0){ ?>
				...
				<div class="box-content">
					...
					<div class="column4" style="padding:0;margin:0;width:120px;">
						<?php
						if($outcome_item['accunit'] == 1 && $outcome_item['accdept'] == 1)
						{
							...
							elseif($outcome_item['accunit_date'] != "0000-00-00 00:00:00" && $outcome_item['accunit'] == 0)
							{ echo '<img src="'.ASSETS_DIR_IMG.'notdone.png"><br>
