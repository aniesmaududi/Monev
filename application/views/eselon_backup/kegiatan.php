			...
			<div id="nav-box">
				...
				<div class="box-content">
					...
					<table>
						<tr>
							<td class="button"><a href="<?php echo base_url();?>eselon/realisasi/<?php echo $kegiatan_item['kddept'];?>-<?php echo $kegiatan_item['kdunit'];?>-<?php echo $kegiatan_item['kdsatker'];?>-<?php echo $kegiatan_item['kdprogram'];?>-<?php echo $kegiatan_item['kdgiat'];?>" class="custom">Pengesahan Realisasi</a></td>
							<td class="mark">
