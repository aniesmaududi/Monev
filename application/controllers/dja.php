...
class Dja extends CI_Controller
{
    ...
    function index()
    {
		...
		$this->data['penyerapan'] = get_penyerapan('2011');
		$this->data['konsistensi'] = get_konsistensi('2011');
		$this->data['keluaran'] = get_keluaran('2011');
		$this->data['efisiensi'] = get_efisiensi('2011');
